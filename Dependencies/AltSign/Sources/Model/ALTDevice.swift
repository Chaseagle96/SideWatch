...
public struct ALTDeviceType: OptionSet {
    ...
    /// Apple Watch / watchOS. This is kept separate from iOS because Apple
    /// issues watchOS provisioning profiles for embedded WatchKit bundles.
    public static let watch   = ALTDeviceType(rawValue: 1 << 4)

    public static let none: ALTDeviceType = []
    public static let all: ALTDeviceType = [.iPhone, .iPad, .appleTV, .watch]
